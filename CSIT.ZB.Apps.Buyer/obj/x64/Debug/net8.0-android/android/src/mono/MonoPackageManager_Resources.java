...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CSIT.ZB.Apps.Buyer.dll" comes first in this list. */
		"CSIT.ZB.Apps.Buyer.dll",
		...
		"Microsoft.Maui.Controls.resources.dll",
		"Microsoft.Maui.Controls.resources.dll",
		"CSIT.ZB.Apps.DataModels.dll",
		"CSIT.ZB.Apps.Repository.dll",
		"CSIT.ZB.Apps.ServiceModels.dll",
		"CSIT.ZB.Apps.ViewModels.dll",
